export default function AnalyticsAlertsLoading() {
  return (
    <div className="space-y-6 font-ui">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {[0, 1, 2, 3].map((item) => (
          <div key={item} className="rounded-[8px] border border-[#EEEEEE] bg-white p-5 shadow-sm">
            ...
            <div className="mt-3 h-7 w-16 animate-pulse rounded bg-[#E6E7E8]" />
          </div>
        ))}
      </div>

      <div className="rounded-[8px] border border-[#EEEEEE] bg-white p-4 shadow-sm">
        <div className="h-4 w-28 animate-pulse rounded bg-[#E6E7E8]" />
      ...
      <div className="rounded-[8px] border border-[#EEEEEE] bg-white shadow-sm">
        <div className="border-b border-[#EEEEEE] px-5 py-4">
          <div className="h-5 w-32 animate-pulse rounded bg-[#E6E7E8]" />
          <div className="mt-2 h-4 w-56 animate-pulse rounded bg-[#E6E7E8]" />
        </div>
          ...
          {[0, 1, 2].map((item) => (
            <div key={item} className="px-5 py-5">
              <div className="mb-3 flex gap-2">
                ...
                <div className="h-6 w-24 animate-pulse rounded-full bg-[#E6E7E8]" />
              </div>
              <div className="h-5 w-72 animate-pulse rounded bg-[#E6E7E8]" />
              <div className="mt-2 h-4 w-full max-w-xl animate-pulse rounded bg-[#E6E7E8]" />
            </div>
          ))}
        </div>
      </div>
