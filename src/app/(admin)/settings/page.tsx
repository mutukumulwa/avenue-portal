...
export default async function SettingsPage() {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-8">
      <div>
        <h1 className="text-2xl font-bold text-brand-text-heading font-heading">Settings</h1>
        <p className="text-brand-text-body font-body mt-1">Manage users, integrations, and notification templates.</p>
      </div>
      ...
      {/* Integrations */}
      <section className="space-y-4">
        <h2 className="text-lg font-bold text-brand-text-heading font-heading">Integrations</h2>
      ...
      <section className="space-y-4">
        <div className="flex justify-between items-center">
          <h2 className="text-lg font-bold text-brand-text-heading font-heading">Notification Templates</h2>
        </div>
