  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      <div className="flex items-center gap-3">
        <Link href="/billing" className="text-avenue-text-muted hover:text-avenue-indigo transition-colors">
          <ArrowLeft size={20} />
        </Link>
        <div>
          <h1 className="text-2xl font-bold text-avenue-text-heading font-heading">Bank Statement Reconciliation</h1>
      ...
      <div className="bg-white border border-[#EEEEEE] rounded-[8px] shadow-sm p-5 space-y-3">
        <h2 className="font-semibold text-avenue-text-heading text-sm">Expected Statement Format</h2>
            ...
            <thead>
              <tr className="bg-[#E6E7E8]">
                {["A: Date", "B: Description", "C: Reference", "D: Debit (KES)", "E: Credit (KES)", "F: Balance (KES)"].map((h) => (
                  <th key={h} className="border border-[#EEEEEE] px-3 py-2 text-left font-bold text-avenue-text-heading whitespace-nowrap">{h}</th>
                ))}
              </tr>
            </thead>
            <tbody>
              <tr>
                {["2026-05-01", "RTGS — Safaricom Ltd", "INV-2026-00012", "", "450,000", "1,200,000"].map((v, i) => (
                  <td key={i} className="border border-[#EEEEEE] px-3 py-2 font-mono text-avenue-text-muted">{v}</td>
                ))}
              </tr>
            </tbody>
          </table>
        </div>
        <p className="text-xs text-avenue-text-muted flex items-center gap-1">
      ...
      <div className="bg-white border border-[#EEEEEE] rounded-[8px] shadow-sm p-5 space-y-2">
        <h2 className="font-semibold text-avenue-text-heading text-sm mb-3">Match Types</h2>
      ...
      <div className="bg-white border border-[#EEEEEE] rounded-[8px] shadow-sm p-5 space-y-4">
        <h2 className="font-semibold text-avenue-text-heading text-sm">Upload Statement</h2>
        <form action="/api/billing/reconcile" method="POST" encType="multipart/form-data"
          ...
          <div className="border-2 border-dashed border-[#EEEEEE] rounded-[8px] p-8 text-center hover:border-avenue-indigo transition-colors">
            ...
            <p className="text-sm text-avenue-text-muted">Drop your statement here or</p>
            ...
            <p className="text-[11px] text-avenue-text-muted mt-1">.xlsx, .xls, or .csv — max 5 MB</p>
          </div>
      ...
      <p className="text-xs text-avenue-text-muted text-center">
