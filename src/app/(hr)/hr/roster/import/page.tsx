    ...
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href="/hr/roster" className="text-avenue-text-muted hover:text-avenue-indigo transition-colors">
            <ArrowLeft size={20} />
          </Link>
          <div>
            <h1 className="text-2xl font-bold text-avenue-text-heading font-heading">Bulk Add Endorsements</h1>
            <p className="text-avenue-text-body text-sm mt-0.5">Submit multiple addition requests using a CSV file.</p>
          </div>
        </div>
        <a
