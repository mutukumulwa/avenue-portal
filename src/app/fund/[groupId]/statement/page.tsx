    ...
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-brand-text-heading font-heading">Fund Statement</h1>
      ...
      <div className="bg-white border border-[#EEEEEE] rounded-[8px] p-6 shadow-sm">
        <div className="flex justify-between items-start mb-6">
          <div>
            <p className="text-xs font-bold uppercase text-brand-text-muted">Scheme</p>
            <p className="text-lg font-bold text-brand-text-heading mt-0.5">{group.name}</p>
      ...
      {catBreakdown.length > 0 && (
        <div className="bg-white border border-[#EEEEEE] rounded-[8px] p-5 shadow-sm">
          <h3 className="font-bold text-brand-text-heading text-sm mb-4">Claims Breakdown by Category</h3>
      ...
      <div className="bg-white border border-[#EEEEEE] rounded-[8px] shadow-sm overflow-hidden">
        <div className="px-5 py-4 border-b border-[#EEEEEE]">
          <h3 className="font-bold text-brand-text-heading text-sm">Full Transaction Ledger</h3>
        </div>
        <table className="w-full text-sm">
          <thead>
          ...
          <tbody className="divide-y divide-[#EEEEEE]">
            ...
            {txns.length === 0 && (
              <tr><td colSpan={6} className="px-4 py-8 text-center text-brand-text-muted text-sm">No transactions.</td></tr>
            )}
          </tbody>
        </table>
      </div>
