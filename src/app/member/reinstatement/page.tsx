...
export default async function MemberReinstatementPage() {
  ...
  if (!member) return (
    <div className="p-6 text-brand-text-body">No member profile found.</div>
  );
    ...
    <div className="max-w-2xl mx-auto p-6 space-y-6">
        ...
        <div className="bg-white border border-[#EEEEEE] rounded-lg p-6 shadow-sm space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div className="bg-[#F8F9FA] p-3 rounded">
              <p className="text-brand-text-muted text-xs font-bold uppercase">Months lapsed</p>
      ...
      {!isLapsed && !pending && (
        <div className="bg-white border border-[#EEEEEE] rounded-lg p-6 shadow-sm text-center">
          ...
          <h2 className="font-bold text-brand-text-heading">Your membership is active</h2>
          <p className="text-sm text-brand-text-muted mt-1">No reinstatement is needed at this time.</p>
        </div>
      )}
