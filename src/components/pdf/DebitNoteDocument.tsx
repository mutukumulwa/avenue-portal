...
const s = StyleSheet.create({
  ...
  header: { flexDirection: "row", justifyContent: "space-between", borderBottomWidth: 1.5, borderBottomColor: "#292A83", paddingBottom: 18, marginBottom: 20 },
  brand: { fontSize: 20, fontWeight: "bold", color: "#292A83" },
  brandSub: { fontSize: 9, color: "#6C757D", marginTop: 3 },
  docTitle: { fontSize: 22, fontWeight: "bold", color: "#292A83", textAlign: "right" },
  ...
  tableHeaderText: { fontWeight: "bold", color: "#292A83", fontSize: 9, textTransform: "uppercase" },
  ...
  totalRow: { flexDirection: "row", padding: "10 10", backgroundColor: "#292A83", borderBottomLeftRadius: 4, borderBottomRightRadius: 4 },
