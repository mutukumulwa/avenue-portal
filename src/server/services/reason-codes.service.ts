...
export const REASON_CODE_CATALOG: ReasonCodeSeed[] = [
  ...
  // ── Benefit (P1.5 — availability gate; decisions in uat/priority-six/P1_BENEFIT_DECISIONS.md) ──
  { code: "BENEFIT_CATEGORY_EXHAUSTED", category: "Benefit", internalDescription: "Approval exceeds the member's remaining category annual sublimit", providerDescription: "The member's annual benefit for this category is insufficient for the requested amount.", memberDescription: "Your annual benefit allowance for this category is not sufficient for this service.", defaultSeverity: "REJECT", remedy: "Approve an explicit partial amount up to the remaining balance, or decline.", resubmissionAllowed: true, overrideAllowed: false },
  { code: "BENEFIT_OVERALL_EXHAUSTED", category: "Benefit", internalDescription: "Approval exceeds the package's overall annual limit", providerDescription: "The member's overall annual cover is insufficient for the requested amount.", memberDescription: "Your overall annual cover is not sufficient for this service.", defaultSeverity: "REJECT", remedy: "Approve an explicit partial amount up to the remaining overall cover, or decline.", resubmissionAllowed: true, overrideAllowed: false },
  { code: "BENEFIT_SHARED_LIMIT_EXHAUSTED", category: "Benefit", internalDescription: "Approval exceeds a member-scoped shared benefit pool", providerDescription: "A combined benefit pool covering this category is insufficient for the requested amount.", memberDescription: "A combined allowance covering this service is not sufficient.", defaultSeverity: "REJECT", remedy: "Approve an explicit partial amount up to the pool remainder, or decline.", resubmissionAllowed: true, overrideAllowed: false },
  { code: "BENEFIT_FAMILY_LIMIT_EXHAUSTED", category: "Benefit", internalDescription: "Approval exceeds the family shared benefit pool (principal + dependants)", providerDescription: "The family's shared benefit pool is insufficient for the requested amount.", memberDescription: "Your family's shared allowance is not sufficient for this service.", defaultSeverity: "REJECT", remedy: "Approve an explicit partial amount up to the family pool remainder, or decline.", resubmissionAllowed: true, overrideAllowed: false },
  { code: "BENEFIT_PER_VISIT_EXCEEDED", category: "Benefit", internalDescription: "Approval exceeds the per-visit limit for the benefit", providerDescription: "The requested amount exceeds the per-visit limit for this benefit.", memberDescription: "This service exceeds the per-visit allowance for your benefit.", defaultSeverity: "REJECT", remedy: "Approve up to the per-visit limit, or decline.", resubmissionAllowed: true, overrideAllowed: false },
  { code: "BENEFIT_CONCURRENCY_RETRY", category: "Benefit", internalDescription: "Two decisions raced on the same benefit balance — the losing transaction was rolled back", providerDescription: "The decision could not be recorded because another was in progress; please retry.", memberDescription: "Your request is being processed; the decision will follow shortly.", defaultSeverity: "PEND", remedy: "Retry the decision; nothing was changed by the aborted attempt.", resubmissionAllowed: true, overrideAllowed: false },
];
