# P01.02 — Family tariff remediation manifest (FH-P0102-20260911-R2)

Manifest SHA-256: `75b648ebd211dd96dab6dd92b17936e423dffe88c1f90d27c0364c0bee5de9f4` — the value a reviewer approves and `--apply --manifest-hash` must quote.
...
- `cmtcjm9qk00164yvqhj4o41qb` → **Excision of Dermatosis papulosa nigra (more than 5 lesions)** (fingerprint `cdbc7b022cd9ecc9…`)
- `cmtcjm9qk00174yvq0yaju8yq` → **Excision of Dermatosis papulosa nigra (less than 5 lesions)** (fingerprint `9ccc1e126ddb4a25…`)
...
- `cmtcjmd1900g14yvqvxl843ei` → **Azithromycin 500Mg (Vial)** (fingerprint `4ee905ded444232a…`)
- `cmtcjmd1a00i64yvqn3bfa16z` → **Azithromycin 500Mg (Tab)** (fingerprint `0510d932c077001a…`)
...
- `cmtcjme9s00yu4yvqvsq7brrb` → **Rabeprazole 20Mg (Rabeloc) (Vial)** (fingerprint `e18300fe25e5af91…`)
- `cmtcjme9t01164yvq6mdlfzht` → **Rabeprazole 20Mg (Rabeloc) (Tab)** (fingerprint `71a323b3ebb5055b…`)
